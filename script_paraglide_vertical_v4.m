...
[t, x] = ode45(@dx_dt, [0:0.5:10], [dual_omega; dual_q], options);
...
Fg_wing     = nsk2ssk(gamma, psi, theta)*Fg_wing_nsk;
...
Fg_payload     = nsk2ssk(gamma, psi, theta)*Fg_payload_nsk;
...
Fp = mass*(-(eye(3) + k1*k2)*(r - [r(1); 20; 0]) ...
           -(k1 + k2)*(V - [V(1); 0; 0]) ...
...
Mp = J*(-(eye(3) + k1*k2)*[gamma; psi; theta] ...
        -(k1 + k2)*omega ...
