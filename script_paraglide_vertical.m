...
% -------------------------------------------------------------------------
Rg_wing     = [0 0.3 0];                                  % точка приложения силы в ССК
...
% -------------------------------------------------------------------------
Rg_payload     = [0 -2.5 0];                                   % точка приложения силы в ССК
...
Ra_wing     = [0.2-Cd 3 0]; % точка приложения силы в ССК, зависит от угла атаки

Fa_pssk = [-Cx Cy Cz]*q*S_wing;       % сила в ПССК
...
Rp = [0.0 -0.5 0.0];       % точка приложения силы в ССК
